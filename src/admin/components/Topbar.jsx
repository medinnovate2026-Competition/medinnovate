...
const searchableSections = [
  ...
  { title: "Partner Sections", description: "Gergian regional and outreach partners", path: "/admin/academic-partners", tags: "partners institutions gergian regional outreach logos" },
