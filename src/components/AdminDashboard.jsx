    ...
    <div className="min-h-screen bg-[#0B1B2B] text-[#E6F1FF] p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          {teams.length === 0 ? <p className="text-gray-400 text-center text-lg mt-20">No teams registered yet.</p> : teams.map((team, index) => <TeamCard key={index} team={team} onVerify={handleVerify} />)}
        </div>
      </div>
    </div>
  );
