    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-purple-300/15 bg-[#09051A]/75 shadow-[0_18px_60px_rgba(0,0,0,0.28)] backdrop-blur-2xl">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <a href="#hero" className="flex items-center gap-3">
          <span className="grid h-9 w-9 place-items-center rounded-xl border border-purple-300/40 bg-purple-400/15 text-sm font-black text-purple-100 shadow-[0_0_26px_rgba(168,85,247,0.36)]">
            MI
          </span>
          <span className="font-display text-base font-black tracking-wide text-white sm:text-lg">
            MedInnovate 2.0
          </span>
        </a>
